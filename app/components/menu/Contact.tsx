      ...
      <div className="max-w-6xl mx-auto">
        <FadeUp>
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gradient-primary pb-4 filter drop-shadow-[0_0_15px_rgba(168,85,247,0.8)] drop-shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all duration-300">
              Hubungi Alfian Jack
            </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-white/10 border-purple-500/30 text-purple-400 placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20 rounded-xl py-3"
                        required
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="bg-white/10 border-purple-500/30 text-purple-400 placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400/20 min-h-[120px] rounded-xl resize-none"
                      required
                    />
                  </div>
