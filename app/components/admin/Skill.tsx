          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {skills.map((skill, index) => (
              <FadeUp key={index} delayMs={(index % 4) * 60}>
                <Card className="bg-gray-900 border-gray-700 hover:border-purple-500 motion-safe:transition-all motion-safe:duration-300 hover:transform hover:-translate-y-1 hover:scale-105 glow-purple">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-semibold text-gray-100 mb-2 group-hover:text-purple-400 transition-colors">
                      {skill.name}
                    </h3>
                    <Badge
                      variant="secondary"
                    ...
                    <div className="mt-4">
                      ...
                      <div className="mt-3 flex items-center gap-1">
                        ...
                        <div className="ml-2 text-xs text-purple-300 font-medium flex items-center gap-1">
